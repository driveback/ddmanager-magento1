...
/**
 * Class Driveback_DigitalDataManager_Model_Ddl
 *
 * @method Driveback_DigitalDataManager_Model_Ddl setVersion() setVersion(mixed $version)
 * @method Driveback_DigitalDataManager_Model_Ddl setEvents() setEvents(array $events)
 * @method Driveback_DigitalDataManager_Model_Ddl setProduct() setProduct($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setPage() setPage($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setUser() setUser($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setListing() setListing($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setCart() setCart($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setTransaction() setTransaction($data)
 * @method Driveback_DigitalDataManager_Model_Ddl setMagentoVersion() setMagentoVersion(mixed $version)
 */

class Driveback_DigitalDataManager_Model_Ddl extends Varien_Object
{
    ...
    /**
     * @return Driveback_DigitalDataManager_Helper_Data
     */
    protected function helper() {
        return Mage::helper('driveback_ddm');
    }
     ...
     *
     * @see Driveback_DigitalDataManager_Model_Observer::processListingData
     */
